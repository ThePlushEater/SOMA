...
export default class HomeCanvas extends  React.Component {
  ...
  render() {
    return <svg ref="canvas" className="home-canvas">
      ...
      <Cloud id={1} coords={{x: this.state.width * 0.4, y: this.state.height * 0.15, scale: 0.75}} width={this.state.width} height={this.state.height} animating={this.props.focus} />
      <Cloud id={2} coords={{x: this.state.width * 0.25, y: this.state.height * 0.25, scale: 0.65}} width={this.state.width} height={this.state.height} animating={this.props.focus} />
      <Cloud id={3} coords={{x: this.state.width * 0.75, y: this.state.height * 0.265, scale: 0.45}} width={this.state.width} height={this.state.height} animating={this.props.focus} />
      <Cloud id={4} coords={{x: this.state.width * 0.65, y: this.state.height * 0.1, scale: 0.55}} width={this.state.width} height={this.state.height} animating={this.props.focus} />
